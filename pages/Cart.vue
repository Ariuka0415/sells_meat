<template>
  <div class="cartItems my-[100px] mx-[150px]">
    <div
      class="format-main grid grid-cols-custom items-center gap-[75px] py-[20px] px-0 text-[#454545] text-[18px] font-semibold"
    >
      <p>Бүтээгдэхүүн</p>
      <p>Нэр</p>
      <p>Үнэ</p>
    ...
    <hr class="h-[3px] bg-[#e2e2e2] border-0" />
    <!-- items here -->
    <div class="calculator flex my-[100px] mx-0">
      <div
        class="items-total flex-1 flex flex-col mr-[100px] gap-[40px] font-semibold"
      >
        <h1>Нийт үнэ</h1>
        <div>
          <div class="total-item flex justify-between py-[15px] px-0">
            <p>Тоо хэмжээ</p>
            <p>0</p>
          </div>
          <hr />
        ...
        <button
          class="uppercase w-[200px] h-[40px] outline-none border-none bg-[#c53831] text-[#ffffff] text-[16px] font-semibold cursor-pointer"
        >
          Төлбөр төлөх
        </button>
      </div>
